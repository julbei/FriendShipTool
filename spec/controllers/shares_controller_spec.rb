...
describe SharesController do
  ...
  let(:valid_attributes) { { "accounting" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved share as @share" do
        ...
        post :create, {:share => { "accounting" => "invalid value" }}, valid_session
        assigns(:share).should be_a_new(Share)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested share" do
        ...
        Share.any_instance.should_receive(:update).with({ "accounting" => "" })
        put :update, {:id => share.to_param, :share => { "accounting" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the share as @share" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Share.any_instance.stub(:save).and_return(false)
        put :update, {:id => share.to_param, :share => { "accounting" => "invalid value" }}, valid_session
        assigns(:share).should eq(share)
      end
